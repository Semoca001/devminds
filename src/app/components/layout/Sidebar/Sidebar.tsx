...
const Sidebar = () => {
  ...
  return (
    <div>
      ...
      <div className="hidden lg:flex flex-col fixed top-0 left-0 h-full w-20 bg-dark-gray border-r border-border-primary z-[9998]">
        {/* Botón de menú en la parte superior */}
        <button 
          onClick={toggleSidebar} 
          className="absolute top-4 w-full flex items-center justify-center text-text-primary hover:text-primary transition-colors duration-300"
      ...
      <div className="lg:hidden fixed top-0 left-0 w-full bg-dark-gray border-b border-border-primary z-[9998] flex justify-between items-center">
        ...
        <button 
          onClick={toggleSidebar} 
          className="p-4 text-text-primary hover:text-primary transition-colors duration-300 flex items-center justify-center"
          aria-label={isOpen ? "Cerrar menú" : "Abrir menú"}
        >
          {isOpen ? (
            <Image src="/images/close.svg" alt="Cerrar menú" width={36} height={36} />
